...
{
	std::string prepath("assets/vol_3/");
...
bool load_files()
{
    ...
    //Open the font
    font = TTF_OpenFont( "assets/vol_3/tnr.ttf", 22 );
    font_small = TTF_OpenFont( "assets/vol_3/tnr.ttf", 15 );
...
int main( int argc, char* args[] )
{
    ...
    //                 then shows the enemy animations, then sends control back to player.
                       ...
                       //check second for sub selection
                        ...
                        {
                            if( ary == 350 )
                                { choose3 = 1; arx = 435; ary = 110; break;}
                            else if( ary == 390 )
                                { choose3 = 2; arx = 435; ary = 110; break;}
                            else if( ary == 430 )
                                { choose3 = 3; arx = 435; ary = 110; break;}
                            else
                                {break;}
                        }
                        ...
                        else if(arx == 280)
                        {
                            ...
                            if( ary == 350 )
                                {choose2 = 1; arx = 435; ary = 110; break;}
...
if ( left == true)
    ...
    if( running == true )
    {
        ...
        apply_surface( 300, 150,cheese1, screen );
        apply_surface( 300, 170, cheese2, screen );
        apply_surface( 300, 190, cheese3, screen );
        apply_surface( 300, 210, cheese4, screen );
