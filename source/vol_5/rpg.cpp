...
//if enemies are weaker against certain magic
...
{
	std::string prepath("assets/vol_5/");
...
{
    //Load the music
    dark_winds = Mix_LoadMUS( "assets/vol_5/Dark Winds.wav" );
    battle_theme = Mix_LoadMUS( "assets/vol_5/Battle Theme.wav" );
    ...
    //Open the font
    font = TTF_OpenFont( "assets/vol_5/tnr.ttf", 22 );
    font_small = TTF_OpenFont( "assets/vol_5/tnr.ttf", 15 );
...
while(quit == false)
{
    ...
    //              this is where the control switches from the player and then the program takes over and
    //                 then shows animations, then sends control back to player.
                                    //this is if player1 is the first selection
                                if(order1 == 1)
                                {
                                        char1x = 65;
                                        //the animations for player1 will go right here
                                        ...
                                        else if(player1_array[0] == 2)
                                        {
                                           ...
                                           //if the magic sub selection is Power X2
                                            else if(player1_array[1] == 2)
                                            {
                                                player1_magic = player1_magic - power_magic;
                                   ...
                                   //now the first two enemies do their thing and this is where enemy animations 1 & 2 go
                                   //insert enemy1 animation
                                   if(bad1 == true)
                                   {
                                   ...
                                   if(bad2 == true)
                                   {
                                    ...
                                    if( order2 == 2)
                                    {
                                        ...
                                        else if(player2_array[0] == 2)
                                        {
                                           ...
                                           //if the magic sub selection is Freeze
                                            ...
                                            {
                                                player2_magic = player2_magic - 10;
                                    ...
                                    //now the now enemies 3 and 4 attack
                                   //insert enemy1 animation
                                   if(bad3 == true)
                                   {
                                    enemy_random = 1 + rand() % 3;
                                   ...
                                   if(bad4 == true)
                                   {
                                    ...
                                    //insert enemy4 animation
                                        ...
                                        //now do the third persons actions
                                        if(order3 == 3)
                                        {
                                            char3x = 65;
                                        //the animations will go right here
                                        ...
                                        {
                                            //if the magic sub selection is Protect
                                            if(player3_array[1] == 1)
                                            {
                                                player3_magic = player3_magic - protect_magic;

                                            }
                                           //if the magic sub selection is Taunt
                                            else if(player3_array[1] == 2)
                                            {
                                                player3_magic = player3_magic - taunt_magic;
                                        ...
                                        //now have the last group of enemies attack
                                        if(bad5 == true)
                                        {
                                            enemy_random = 1 + rand() % 3;
                                    if(enemy_random == 1)
                                    ...
                                    else if(order2 == 3)
                                    {
                                        ...
                                        else if(player3_array[0] == 2)
                                        {
                                           ...
                                           //if the magic sub selection is Taunt
                                            ...
                                            {
                                                player2_magic = player2_magic - taunt_magic;
                                    ...
                                    //now reset all of the original values
                                    arx = 15; ary = 350;
...
//Scroll background
    ...
    if(bad1 == true)
    {
        apply_surface( 440, 85, enemy1, screen);
        apply_surface( 420, 140, enemy1_health_text, screen);
    }
    if(bad2 == true)
    {
        apply_surface( 440, 165, enemy1, screen);
        apply_surface( 420, 220, enemy2_health_text, screen);
    }
    if(bad3 == true)
    {
        apply_surface( 440, 245, enemy1, screen);
        apply_surface( 420, 300, enemy3_health_text, screen);
    }
    if(bad4 == true)
    {
        apply_surface( 550, 85, enemy1, screen);
        apply_surface( 530, 140, enemy4_health_text, screen);
    }
    if(bad5 == true)
    {
        apply_surface( 550, 165, enemy1, screen);
        apply_surface( 530, 220, enemy5_health_text, screen);
    }
    if(bad6 == true)
    {
        apply_surface( 550, 248, enemy1, screen);
