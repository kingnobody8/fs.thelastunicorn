...
bool load_files()
{
    ...
    walking = Mix_LoadMUS( "A Walk in the Land of the Last Unicorn.wav" );
    win_music = Mix_LoadMUS( "FTW.wav" );
    loss_music = Mix_LoadMUS( "Epic Loss.wav" );
    hood_on = Mix_LoadMUS( "The Hood Is On.wav" );
    hood_off = Mix_LoadMUS( "The Hood Is Off.wav" );
    climax = Mix_LoadMUS( "Climax.wav" );
    end_music = Mix_LoadMUS( "Ending Title.wav" );
